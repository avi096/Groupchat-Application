...
public class User_three extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent act)
    {
        try{
            ...
            if("quit".equalsIgnoreCase(out) || "exit".equalsIgnoreCase(out))
            {
                ...
                String exit_msg = " Rohit left the Group....... ";
                byte[] write = exit_msg.getBytes();
                DatagramPacket data = new DatagramPacket(write, 0, write.length, address);
                socket.send(data);
                System.exit(1);
    ...
    public static void main(String[] args){
        new User_three().setVisible(true);
